...
function NativePlayer({ src, onOrientation }) {
  ...
  return (
    <div
      ref={containerRef}
      // Added dynamic responsiveMaxWidthClass here
            ...
            <div className="flex flex-col gap-4">
              ...
              {project.description && (
                <div
                  ...
                  className="
      mt-2 max-h-[180px] sm:max-h-[240px] lg:max-h-[280px] 
      overflow-y-auto pr-3 
      font-sans text-sm md:text-base text-white/70 leading-relaxed whitespace-pre-wrap lg:break-words
      
      /* Sleek Red Scrollbar Styling */
      [scrollbar-width:thin] 
      [scrollbar-color:hsl(0_85%_55%)_rgba(255,255,255,0.05)]
