...
export function Photography() {
  ...
  return (
    <section id="stills" ref={sectionRef} className="relative bg-secondary/30 overflow-hidden md:h-screen">
      ...
      <div className="md:hidden flex overflow-x-auto snap-x snap-mandatory gap-4 px-6 pt-8 pb-16 w-full [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        {BTS_PHOTOS.map((img, i) => (
          <figure key={img.id} className="relative shrink-0 w-[85vw] snap-center">
            <div className="relative aspect-[4/5] overflow-hidden bg-secondary">
              <OptimizedImage priority={true} src={img.src} alt={img.caption} sizes="85vw" className="object-cover" />
      ...
      <div className="hidden md:flex md:h-screen md:items-center md:overflow-visible">
        <div ref={trackRef} className="flex gap-10 pl-[40vw] pr-[20vw] will-change-transform">
          {BTS_PHOTOS.map((img, i) => (
            <figure key={img.id} data-bts className="group relative shrink-0 w-[32vw]">
