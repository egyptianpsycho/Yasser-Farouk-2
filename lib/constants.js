...
export const PROJECTS_VIDEOS = [
  {
    id: 1,
    title: "al tasis alsaleem",
    description: `latest for altasisalsaleem
    Production house : saltandpepper_eg
    Director : Abdallah salama
    Creative Director : artsy_debos
    DOP: yasserfarouk_ph
    Producer : abdallah.mohamed.salah
    As producer : moustafayounis
    Focus puller: ragabbahmedd
    Ist AD : zvkzouk
    Actor's : Mohamed Hassan, mahmoud_nooh, selim, mazen.muhammea.5855, sama_kesba
    Sound engineer : Felix
    Gaffer & Camera : Mr Sameh
    Makeup : ahmea_badawy26
    Location: rock_studios
    Editing : amr._.noureldin
    Coloring: michael.maged.50
    motion graphics : abuelnour.ibrahim
    Vo: soliman.speaks
    Bts: el_s03da
    Assistant: ab_do_em_ad`,
    thumbnail:
  ...
  },
  {
    id: 4,
    title: "lili's room",
    description: `latest for lili’s Room
    Production house : saltandpepper_eg
    Marketing agency : Recy_adv`,
    thumbnail:
